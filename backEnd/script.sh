...
CREATION_TIME=`date +%s` ASSET_BUNDLE_PROJECT_DIR=/c/TangoProject/backEnd/tmp/AssetBundle-${CREATION_TIME}
...
RESOURCE_FILE=/c/TangoProject/backEnd/resource
...
public class AssetsBundler
{
    ...
    static void BuildAllAssetBundles()
    {
        ...
        BuildPipeline.BuildAssetBundles("C:/TangoProject/backEnd/AssetsBundle", buildMap, BuildAssetBundleOptions.None, BuildTarget.StandaloneWindows);
    }
}
